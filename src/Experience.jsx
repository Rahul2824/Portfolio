...
<div className='right-div'>
    <div className='para-1'>  <h1>Frontend Development</h1> 
 <h3>React.js, Redux, Formik with Yup</h3> <br /> 
<h3>●Advanced skills in React.js for building dynamic web applications. <br /> <br />
●Expertise in Redux for efficient state management. <br /> <br />
●Experience with Formik and Yup for seamless form handling and validation. <br /> <br />
●Applied Flux architecture to enhance data flow and maintainability. <br /> <br />
●Implemented advanced architectural patterns for scalable applications. <br /> <br />
●These are just a few of the many libraries</h3><br />
</div> </div>
